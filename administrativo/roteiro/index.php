	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Roteiros <small>Bem-vindo</small></h3>
				</div>
			...
			<div class="block">
	        	<h6 class="heading-hr"><i class="icon-grid"></i>Roteiros</h6>
				<a href="../roteiro/alterar.php?ref=<?php echo base64_encode('NOVO'); ?>" style="float:right; margin-top: -60px" class="btn btn-info"><i class="icon-plus"> </i> NOVO</a>
	            <div class="tasks">
