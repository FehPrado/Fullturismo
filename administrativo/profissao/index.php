...
<!-- Tasks table -->
	        <div class="block"><h6 class="heading-hr"><i class="icon-grid"></i>Profissões</h6>
				...
				<div class="tasks">
	                <table class="table table-bordered">
	                    ...
	                    <tbody>
							...
							<?php
							include('../conexao.php');							
							$query = mysqli_query($conecta,"SELECT * FROM profissoes ORDER BY nome");
							if(mysqli_num_rows($query) > 0){
								while($result = mysqli_fetch_assoc($query)){
									...
									//echo "<td class='text-center'><span class='label label-success'>" . $result['nome'] . "</span></td> ";
									echo "
		                            ...
		                            <div class='btn-group'>
										...
										<ul class='dropdown-menu icons-right dropdown-menu-right'>
											<li><a href='alterar.php?PKID=" .base64_encode($result['PKprofissao'])."'><i class='icon-pencil'></i> Editar</a></li>
											<li><a href='#javascript:void(0)' onclick='if(confirm(\"Deseja realmente excluir esse cadastro ?\")){
											 window.location=\"remover.php?PKID=". base64_encode($result['PKprofissao'])."\"}'><i class='icon-remove'></i> Remover</a></li>
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="icon-accessibility"></i>Remover</h4>
						</div>

						<div class="modal-body with-padding">
							<p>Deseja realmente remover o registro?</p>
						</div>
