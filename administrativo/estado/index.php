        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3>Estado <small>Bem-vindo</small></h3>
                </div>
            ...
            <div class="block">
                <h6 class="heading-hr"><i class="icon-grid"></i>Estado</h6>
                <a href="../estado/alterar.php?ref=<?php echo base64_encode('NOVO'); ?>" style="float:right; margin-top: -60px" class="btn btn-info"><i class="icon-plus"> </i> NOVO</a>
                <div class="tasks">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Avaliaçaõ</th>
                        ...
                        <tbody>
                            <?php
								include('../conexao.php');
								$query = mysqli_query($conecta, "SELECT A.*, B.nome as pais FROM estado A, pais B where B.PKID=A.FKpais ORDER BY A.nome") or die(mysqli_error());
                            ...
                            <tr>
                                ...
                                <td><?php echo $result['avaliacao'] ?></td>
