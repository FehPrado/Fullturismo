	...
	<?php include('../sidebar.php') ?>	
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<div class="block">
	        	<h6 class="heading-hr"><i class="icon-grid"></i>Funcionários</h6>
				...
				<div class="datatable-tasks">
	                <table class="table table-bordered">
	                    ...
	                    <tbody>
							<?php
							include('../conexao.php');
							$query = mysqli_query($conecta, "SELECT * FROM funcionario ORDER BY nome");
							if(mysqli_num_rows($query) > 0) {
								while($result = mysqli_fetch_assoc($query)) {
									
									$query1 = mysqli_query($conecta, "SELECT nome FROM profissoes WHERE PKprofissao = ". $result['FKprofissao']);
									...
									echo "<td class='text-center'>" . date('d/m/Y', strtotime ($result['nascimento'])) . "</td>";
									echo "<td class='text-center'><span class='label label-success'>" . $result1['nome'] . "</span></td>";
									echo "
