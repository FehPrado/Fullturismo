	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Palestra <small>Bem-vindo</small></h3>
				</div>
			...
			<div class="block">
	        	<h6 class="heading-hr"><i class="icon-grid"></i>Palestra</h6>
				<a href="../palestra/alterar.php?ref=<?php echo base64_encode('NOVO'); ?>" style="float:right; margin-top: -60px" class="btn btn-info"><i class="icon-plus"> </i> NOVO</a>
	            <div class="tasks">
	                <table class="table table-bordered">
	                    ...
	                    <tbody>
							<?php
								include('../conexao.php');
								$query = mysqli_query($conecta, "SELECT * FROM palestra ORDER BY titulo") or die(mysqli_error());
									...
									<td class='text-center'>
										<div class='btn-group'>
											...
											<ul class='dropdown-menu icons-right dropdown-menu-right'>
												<li><a href='alterar.php?PKID=" <?php echo base64_encode($result['PKID']) ?>. "'>
