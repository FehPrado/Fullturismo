...
if(isset($_POST['btnEnviar'])){
	...
	if(base64_decode($_GET['ref'])=='NOVO') {
		...
		(titulo,descricao, status, docente, datainicio, datatermino, horario, dias, preco, local, herois)	
		VALUES (
	...
	$msg = base64_encode("A palestra foi salvo com sucesso!");
...
if(!empty($_GET["PKID"])) {
	$select = mysqli_query($conecta, "SELECT * FROM palestra WHERE PKID = " . base64_decode($_GET["PKID"]));
	if(mysqli_num_rows($select) == 0) {
		$type = base64_encode("alert-danger");
		$msg = base64_encode("Nenhuma palestra foi encontrado!");
	                ...
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-users2"></i> Cursos</h6></div>
				        ...
				        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <input value="<?php echo $result["titulo"]?>" type="text" name="txttitulo" class="form-control" placeholder="Titulo">
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                        <label>Status:</label>
                                                        <input value="<?php echo $result["status"]?>" type="text" name="txtstatus" class="form-control" placeholder="Aberto">
                                                </div>
