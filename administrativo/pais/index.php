        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3>País <small>Bem-vindo</small></h3>
                </div>
            ...
            <div class="block">
                <h6 class="heading-hr"><i class="icon-grid"></i>País</h6>
                <a href="../pais/alterar.php?ref=<?php echo base64_encode('NOVO'); ?>" style="float:right; margin-top: -60px" class="btn btn-info"><i class="icon-plus"> </i> NOVO</a>
                <div class="tasks">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
								include('../conexao.php');
								$query = mysqli_query($conecta, "SELECT * FROM pais ORDER BY nome") or die(mysqli_error());
