 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<div class="block">
	        	<h6 class="heading-hr"><i class="icon-grid"></i>Vídeos</h6>
				<a href="../video/alterar.php?ref=<?php echo base64_encode('NOVO'); ?>" style="float:right; margin-top: -60px" class="btn btn-info"><i class="icon-plus"> </i> NOVO</a>
	            <div class="tasks">
	                <table class="table table-bordered">
	                    ...
	                    <tbody>
							<?php
								include('../conexao.php');
								$query = mysqli_query($conecta, "SELECT * FROM video ORDER BY titulo") or die(mysqli_error());
							...
							?>
								<tr>
									...
									<td><?php echo $result['restricao'] ?></td>
